...
(function($) {
	...
	jQuery(function(){
        ...
        $('.header__panel .nav-arrw').click(function (e) {
            e.preventDefault();
            var $this = $(this);
            var $wrapNav = $this.closest('li');
            if(!$wrapNav.find('> .list-drop').length)
            {
                return true;
            }
        ...
        // Link favorite add show message
        $('#fn_menu, .header-shop__layer').click(function () {
            $body.toggleClass('dropshow--catalog_menu');
        });

        $('.header-nav__list .link-arrw').click(function (e) {
            e.preventDefault();
            var $this = $(this);
            var $wrapNav = $this.closest('li');
            if(!$wrapNav.find('> .header-nav__drop').length)
            {
                return true;
            }
            $wrapNav.toggleClass('drop--open');
        ...
        $('.header-menu__list .link-arrw').click(function (e) {
            e.preventDefault();
            var $this = $(this);
            var $wrapNav = $this.closest('li');
            $wrapNav.toggleClass('drop--open').siblings('li').removeClass('drop--open');
        });
                ...
                if($query.length >= 3)
                {
                    ...
                    var _dropShow = function ($data) {
                        ...
                        for (var i = 0; i < $data.items.length; i++) {
                            $templateHtml += tmpl("search_group_tmpl", $data.items[i]);
                        }
                                    ...
                                    'data' : [
                                        {
                                            ...
                                            'url'       : '#url-product1',
                                            'image'     : '_img/blank/product-item__01.png'
                                        },
                                        {
                                            'id'        : 'YOUR_ID_PRODUCT',
                                            'stock'     : false,
        ...
        $document.on('click', '.fn_pageload_btn', function(){
            var $this = $(this);
            var $group = $this.closest('.fn_pageload_group');
            var $products = $group.find('.toggle-product');
            $products.toggleClass('toggle-show');
